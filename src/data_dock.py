"""
Loads CSV data into the SQLite database by detecting column types,
creating tables, and inserting rows manually.

AI was used to help improve the loading logic.
